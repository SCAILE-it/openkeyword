...
class Keyword(BaseModel):
    ...
    volume: int = Field(default=0, description="Monthly search volume (from DataForSEO/SE Ranking)")
    difficulty: int = Field(default=50, description="SEO difficulty score (from DataForSEO/SE Ranking)")
    source: str = Field(
